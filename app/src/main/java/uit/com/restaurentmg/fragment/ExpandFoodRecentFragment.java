...
public class ExpandFoodRecentFragment extends Fragment {

    public static ExpandFoodRecentFragment newInstance() {

        Bundle args = new Bundle();

        ExpandFoodRecentFragment fragment = new ExpandFoodRecentFragment();
        fragment.setArguments(args);
        return fragment;
    }

    List<SearchObject> foods = new ArrayList<>();
    @BindView(R.id.expand_food_recent)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_expand_food_recent, container, false);
