...
public class ExpandFoodAllFragment extends Fragment {
    public static ExpandFoodAllFragment newInstance() {

        Bundle args = new Bundle();

        ExpandFoodAllFragment fragment = new ExpandFoodAllFragment();
        fragment.setArguments(args);
        return fragment;
    }

    List<SearchObject> foods = new ArrayList<>();
    @BindView(R.id.expand_food_all)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_expand_food_all, container, false);
