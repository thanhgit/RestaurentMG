...
public class ExpandDrinkRecentFragment extends Fragment {
    public static ExpandDrinkRecentFragment newInstance() {
        
        Bundle args = new Bundle();
        
        ExpandDrinkRecentFragment fragment = new ExpandDrinkRecentFragment();
        fragment.setArguments(args);
        return fragment;
    }

    List<SearchObject> drinks = new ArrayList<>();
    @BindView(R.id.expand_drink_recent)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_expand_drink_recent, container, false);
