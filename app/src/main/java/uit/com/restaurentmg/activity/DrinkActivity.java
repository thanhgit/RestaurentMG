...
public class DrinkActivity extends AppCompatActivity {
    ...
    @BindView(R.id.expandedImageDrink)
    ImageView imageView;

    @BindView(R.id.add_drink_btn)
    ImageButton add_btn;
    @BindView(R.id.subtract_drink_btn)
    ImageButton subtract_btn;
    @BindView(R.id.amount_drink)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle!= null && bundle.getLong("table_id",-1)!=-1){
            talble_id = bundle.getLong("table_id");
            Log.d("table",talble_id+"");
        }else{
